...
class Apartment(models.Model):
    ...
    area = models.DecimalField(max_digits=10,default=0, decimal_places=2, verbose_name="Площадь (m²)")
    ...
    planned_price_per_m2 = models.DecimalField(max_digits=10, default=0, decimal_places=2, blank=True, null=True, verbose_name="Планируемая цена m²")
