...
from .views import apartment_detail, eco_park, about_company, contacts_view, home_view, objects_list_view, project_detail_view, apartments_list
...
urlpatterns = [
    ...
    path('eco_park/',eco_park,name='eco_park'),
